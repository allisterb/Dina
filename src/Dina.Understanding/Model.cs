...
{
    #region Constructors
    public ModelConversation(ModelRuntime runtimeType = ModelRuntime.Ollama, string model = OllamaModels.Gemma3n_2eb_tools, string runtimePath = "http://127.0.0.1:11434", string[]? systemPrompts = null)
    {
